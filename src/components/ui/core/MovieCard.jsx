    ...
    <Card className="centered" >      
        ...
        <Card.Content extra>
          <div className="ui two buttons">
            <Button className={`ui green button ${liked && liked.get(movieId) ? '' : 'basic'}`} onClick={handleLiked} >
                <Icon name="thumbs up" />
                Like
            </Button>
            <Button className={`ui red button ${disliked && disliked.get(movieId) ? '' : 'basic'}`} onClick={handleDisliked} > 
              Dislike
